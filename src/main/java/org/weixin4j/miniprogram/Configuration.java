 ...
 * 微信平台调用基础配置
 *
 * <p>如果存在weixin4j-miniprogram.properties,则加载属性文件中配置的参数</p>
 *
 * @author yangqisheng
 * @since 1.0.0
 */
public class Configuration {
    ...
    static void init() {
        ...
        //读取自定义配置
        String t4jProps = "weixin4j-miniprogram.properties";
        ...
        if (!loaded) {
            System.out.println("weixin4j:没有加载到weixin4j-miniprogram.properties属性文件!");
        }
    }
    ...
    public static String getAppId() {
        return getProperty("weixin4j.appid");
    }
    ...
    public static String getSecret() {
        return getProperty("weixin4j.secret");
    }
